...
| **8.1 Inspect Rule 652 Definition** | *(Dashboard)* **Rules → Search: 652** | [![Fig 8b](../screenshots/phase2/Fig8b.png)](../screenshots/phase2/Fig8b.png) | Reviewed the full definition of Rule 652 — *"Host Unblocked by firewall-drop Active Response"* — confirming it triggers on `if_sid: 650` with `pattern: delete`, and maps to real compliance frameworks: **PCI DSS 11.4**, **GPG13 4.13**, **GDPR IV_35.7.d**, **NIST-800-53 SI.4**, and **TSC CC6.1/CC6.8/CC7.2/CC7.3/CC7.4**. |
